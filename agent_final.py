...
## Class Final Agent 
class Final_Agent(object):
    
    def __init__(self,env,input_dim,n_actions,alpha,gamma,batch_size,lr=5e-4,memory_size=10000000,replace_target=5,
                 filename='final.h5'):
        self.env = env
